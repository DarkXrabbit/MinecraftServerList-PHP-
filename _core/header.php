...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-7003484643660377",
...
-->
    ...
    <meta property="og:title" content="<?php echo $bname.' » '.$info['web']['title'];?>" />
    <meta property="og:type" content="" /> <!-- #類型#-->
    <meta property="og:url" content="" /> <!-- #網址#-->
    <meta property="og:description" content="" /> <!-- #網站說明#-->
    <meta property="og:image" content="" /> <!-- #網站圖片 (顯示在FB預覽的 大必須為484*252)#-->
    <meta property="og:site_name" content="<?php echo $bname.' » '.$info['web']['title'];?>" />
	<!-- #網站內容#-->
...
<div class="mdl-layout__container">
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        ...
        echo '<b><font color="red">403 您沒有權限讀取此頁面。</font></b>';
...
<?php
      ...
      <li><a href="../tos">服務條款 Terms of Service</a></li>
