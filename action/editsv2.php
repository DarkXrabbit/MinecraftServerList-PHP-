...
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
<input class="mdl-textfield__input" type="text" id="query" name="query" required="required" value="<?php echo $row[4]?>">
<label class="mdl-textfield__label" for="query">伺服器Query端口...</label>
</div>
